...
* [Space Combat (SpCo)](#space-combat-spco)
  ...
  * [Space Vessel Critical Hit System](#space-vessel-critical-hit-system)
    * [Step 1: Determine Location](#step-1-determine-location)
    * [Step 2: Determine Severity](#step-2-determine-severity)
    * [Critical Hit Effects By System](#critical-hit-effects-by-system)
      * [Sensors & Comms (1-3)](#sensors--comms-1-3)
      * [Weapons Systems (4-6)](#weapons-systems-4-6)
      * [Engine/Propulsion (7-9)](#enginepropulsion-7-9)
      * [IRHEC & Jump Systems (10-12)](#irhec--jump-systems-10-12)
    ...
    * [Engineering and Damage Controll](#engineering-and-damage-controll)
      * [Emergency Repairs](#emergency-repairs-1)
...
terms in the following order: "close quarter" → "near" → "middle range"
...
given in descriptive terms in the following order: "close quarter" →
...
cafés waiting for warmer times. The window front belies the spaciousness
...
received rendevue coordinates in space with the waiting vessel, Dao´s
...
dedicated combat vessel, it´s interior quit fragile. The detail tries to
...
Dao´s life. They will fight defensivly and retreat in the face of
